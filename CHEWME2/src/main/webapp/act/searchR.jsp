...
<div class="col-md-4  margin_bottom30 activityTemplate">
	<div class="thumbnail">
		...
		</a> <input type="hidden" class="id">
		<div class="blog-content bg-white">
			<img src="<%=request.getContextPath()%>/image/chewme-logo-3-1.png"
				width="50" height="50" style="float: left; vertical-align: middle;">
			<h2 id="" class="act_name"></h2>

			<a class="btn-sm btn btn-info "> <i class="act_price fa fa-usd"
				aria-hidden="true"></i>
			</a> <a class="btn-sm btn btn-info "> <span
				class="act_current glyphicon glyphicon-user"></span>
			</a>
			<hr>
			<p>
				<span>Share : <a
					href="javascript: void(window.open('http://www.facebook.com/share.php?u='.concat(encodeURIComponent(fbhtml_url))));"><i
