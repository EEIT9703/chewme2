...
<link href="<%=request.getContextPath()%>/css/bootstrap.css"
	rel="stylesheet">
<!-- Summernote  -->
<link href="<%=request.getContextPath()%>/css/summernote.css"
	rel="stylesheet">
<!-- Font Awesome  -->
<link
	href="<%=request.getContextPath()%>/css/font-awesome/css/font-awesome.min.css"
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-flag"
										...
										class="form-control" name="act_name" id="act_name" value=""
										placeholder="請輸入活動名稱" /> <font color="red" size="-1"></font>
								</div>
							</div>
						</div>
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i
										...
										type="text" class="form-control" name="act_groups"
										id="act_groups" value="" placeholder="請輸入成團人數" /> <font
						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i
										class="fa fa-users fa" aria-hidden="true"></i></span> <input
										type="text" class="form-control" name="act_current"
										id="act_current" value="" disabled="disabled" />
								</div>
							</div>
						</div>
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i
										...
										type="text" class="form-control" name="BDate" id="BDate"
										value="" placeholder="請選擇出發日期" /> <font color="red" size="-1"></font>
								</div>
							</div>
						</div>
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i
										...
										value="" placeholder="請選擇結束日期" /> <font color="red" size="-1"></font>
								</div>
							</div>
						</div>
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-usd"
										aria-hidden="true"></i></span> <input type="text"
										class="form-control" name="act_price" id="act_price" value=""
										placeholder="請輸入價格" /> <font color="red" size="-1"></font>
								</div>
							</div>
						</div>
